...
PDF_df = pd.read_csv("/Users/scarlettimorse/PycharmProjects/PDFs/d_g1.csv")
...
plot_df = xbins(h_df)
plot_df['g1'] = pd.to_numeric(plot_df['g1'], errors='coerce')
plot_df['X_index'] = pd.to_numeric(plot_df['X_index'], errors='coerce')
...
fig.update_layout(
    ...
    xaxis_title='log(Q²)',
    yaxis_title='g\u2081<sup>d</sup>(x,Q²) + 12.1 - 0.71i',
...
fig.write_html("g1(d)_vs_Q2.html")

pio.write_html(
    fig,
    file='g1(d)_vs_Q2.html',
    auto_open=True,
    config={
